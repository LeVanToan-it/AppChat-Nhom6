...
public class DanhBaActivity extends AppCompatActivity {
    ...
    ImageView imgBtnTinNhan,imgBtnCaNhan;
   ...
   // TextView txtIdHidden;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgBtnTinNhan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(DanhBaActivity.this,GroupActivity.class);
    ...
    public void initViews(){
        ...
        imgBtnTinNhan = (ImageView) findViewById(R.id.imgBtnTinNhan);
    ...
    public void getListContactByAccountId(long id) {
        ...
        String url = LOCALHOST+"/users/byContactOfAccountIdAccepted/"+id;
